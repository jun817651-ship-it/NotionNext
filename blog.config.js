...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '时刻', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://dingya.de5.net/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '节点,博客,搭建节点,TK,推流,tiktok', // 网站关键词 英文逗号隔开
